...
class EditGalleryButton extends ToolbarButton {
	public function __construct(GalleryElement $gallery) {
		$link = BASEURL . '/index.php?section=gallery&task=edit&itemid=' . $gallery->getId ();
		parent::__construct ( _SITE_EDIT, $link, 'edit' );
	}
}
