...
class PublishGalleryButton extends ToolbarButton {
	public function __construct(GalleryElement $gallery) {
		$link = BASEURL . '/index.php?section=gallery&task=publish&itemid=' . $gallery->getId ();
		parent::__construct ( GALLERY_PUBLISH, $link, 'publish' );
	}
}
