...
class UnpublishGalleryButton extends ToolbarButton {
	public function __construct(GalleryElement $gallery) {
		$link = BASEURL . '/index.php?section=gallery&task=unpublish&itemid=' . $gallery->getId ();
		parent::__construct ( GALLERY_UNPUBLISH, $link, 'unpublish' );
	}
}
