...
class NewGalleryButton extends ToolbarButton {
	public function __construct(GalleryElement $gallery) {
		$link = BASEURL . '/index.php?section=gallery&task=new&parentID=' . $gallery->getId ();
		parent::__construct ( _SITE_NEW, $link, 'add' );
	}
}
