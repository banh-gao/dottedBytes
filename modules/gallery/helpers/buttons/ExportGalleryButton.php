...
class ExportGalleryButton extends ToolbarButton {
	public function __construct(GalleryElement $gallery) {
		$link = BASEURL . '/index.php?section=gallery&task=export&itemid=' . $gallery->getId ();
		parent::__construct ( GALLERY_ALBUM_EXPORT, $link, 'download' );
	}
}
